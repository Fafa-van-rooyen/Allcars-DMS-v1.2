...
struct IDCameraScanner: UIViewControllerRepresentable {
    ...
    func makeUIViewController(
        ...
        guard DataScannerViewController.isSupported,
            ...
            let label = UILabel()
            label.text =
                "ID barcode scanning is not available on this device."
        ...
        func dataScanner(
            ...
            for item in addedItems {
                ...
                guard
                    ...
                    let payload =
                        barcode.observation.payloadStringValue,
                    !payload.isEmpty
                else {
                    continue
                }
